...
> **测试口径**（2026-09-20 全仓复核实测）：后端 **1420 passed / 4 skipped**（主检出含 41 角色卡，收集 **1429**；无卡 worktree/CI 约 **1344**）；⚠️ 单进程整跑会在随机位置停住，分块跑法见 `AGENTS.md` §4.3；
...
├── tests/                1424 后端测试通过 + 4 跳过（主检出 2026-09-20 分块实测，收集 1429）+ 98 前端测试
