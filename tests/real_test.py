...
if chars:
    ...
    status, body = api("GET", f"/api/aiyu/characters/{cid}")
...
status, body = api("POST", f"/api/aiyu/emotion-stage/{test_cid}/evaluate?affinity=55")
...
status, body = api("GET", "/api/aiyu/stickers/recommend?emotion_tags=开心&emotion_tags=撒娇&limit=3")
