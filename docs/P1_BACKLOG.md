...
4. **[P1-3] 21 Orphan Pages**: Pages exist in code but have no routes or navigation entry.
...
13. **[P1-12] `AGENTS.md` 修正**: "15 pages" is correct now, but some sections mention "35 pages". Update memory.
...
17. **[P1-16] FF-020 CI Check**: Ruff and MyPy currently `continue-on-error: true`. Needs to be hard-fail.
