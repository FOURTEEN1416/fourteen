...
logger = logging.getLogger("aiyu.api.registry")
...
def setup_aiyu(app: FastAPI | None = None, run_migrate: bool = True) -> AiyuRegistry:
    reg = AiyuRegistry()
