...
- **技术栈**：Python 3.10+ / React 19 / Vite 8 / TypeScript 6 / Tailwind 4 / Zustand 5 / 测试 **1965**（**1867** Py 通过 + 1 跳过，98 FE 通过；2026-09-22 R3-W4 部署实测：服务器收集 **1868** / 0 失败 + CI 全量绿；角色卡 **41 张**）/ MIT
- **核心能力**（见 `README.md`）：
...
| 安全 | 安全开发 | `security/` |
| 测试 | QA | `tests/`（**1867** Python 通过 + 1 跳过；前端 **98**；2026-09-22 R3-W4 部署实测服务器收集 **1868** / 0 失败；现役角色卡 41 张） |
