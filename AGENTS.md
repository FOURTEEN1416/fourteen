...
- **技术栈**：Python 3.10+ / React 19 / Vite 8 / TypeScript 6 / Tailwind 4 / Zustand 5 / 测试 **1786**（**1688** Py 通过 + 1 跳过，98 FE 通过；2026-09-21 selftalk 四项移植后分块实测，收集 **1689**；角色卡 **41 张**）/ MIT
- **核心能力**（见 `README.md`）：
...
| 安全 | 安全开发 | `security/` |
| 测试 | QA | `tests/`（**1688** Python 通过 + 1 跳过；前端 **98**；2026-09-21 selftalk 四项移植后分块实测收集 **1689**；现役角色卡 41 张） |
